...
const DeleteUserProfile = ({ show, setShow, el }) => {
    ...
    <div>
      <Modal show={show} style={{ marginTop: "150px" }}>
        ...
        >
          ...
          <span className="delete-movie-title">Delete Account</span>
          <span className="delete-movie-description">
            You're going to delete your account permanently. Are you sure ?
          </span>
        </Modal.Body>
        <Modal.Footer
          style={{
